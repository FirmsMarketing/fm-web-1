...
<head>
   ...
   <title>Firms Marketing - Digital Agency</title>
   <meta name="description" content="">
   <meta name="viewport" content="width=device-width, initial-scale=1">
   <link rel="canonical" href="https://www.firms.marketing/about-us">
   <?php
      require 'files_css_files.php';
   ?>
</head>

<body>
<?php
      require 'files_header.php';
      require 'files_offcanvas.php';
   ?>
            ...
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content">
                     <h3 class="breadcrumb__title wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".5s">Who We Are</h3>
            ...
            <div class="row">
               <div class="col-xl-5 col-lg-6 wow tpfadeLeft" data-wow-duration=".7s" data-wow-delay=".5s">
                  <div class="ab-inner-content"> 
                     <h4 class="ab-title-xs mb-25">Crafting Digital Excellence,<br> Shaping Market Presence</h4>
                     <p>Welcome to Firms Marketing, your go-to partner for app and web development, digital marketing, graphic design, and brand consultancy. We're dedicated to turning your business visions into reality with our expert services. </p>
                     <div class="tp-inner-list">
                        <ul>
                           <li><i class="far fa-smile"></i> Firms Marketing, where digital dreams are born,</li>
                           <li><i class="far fa-smile"></i> Crafting apps, webs, with creativity sworn.</li>
                           <li><i class="far fa-smile"></i> In digital marketing, graphics, and brand advice,</li>
                           <li><i class="far fa-smile"></i> We make your business vision come to life, precise.</li>
                        </ul>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-xl-5 col-lg-5 wow tpfadeLeft" data-wow-duration=".7s" data-wow-delay=".5s">
                  <div class="service-section-wrapper">
                     ...
                     <div class="tp-service-content mb-20">
                        <h4 class="tp-service-sm-title">We'll ensure you always get the best service</h4>
                        <a class="tp-btn" href="service.php">See all Services</a>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row service-space-left">
                     <div class="col-12 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".5s">
                        <div class="tp-service-item mb-20 d-flex justify-content-between">
                           <div class="tp-service-item__content">
                              <h4 class="tp-service-sm-title"><a href="service.php">Designing<br> Development</a>
                              </h4>
                     ...
                     <div class="col-12 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".7s">
                        <div class="tp-service-item sv-color-blue-one mb-20 d-flex justify-content-between">
                           <div class="tp-service-item__content">
                              <h4 class="tp-service-sm-title"><a href="Marketing.php">Digital<br>
                                    Marketing</a></h4>
                              <div class="tp-service-item__button-link">
                     ...
                     <div class="col-12 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                        <div class="tp-service-item sv-color-blue-two mb-20 d-flex justify-content-between">
                           <div class="tp-service-item__content">
                              <h4 class="tp-service-sm-title"><a href="service.php">Branding <br>
                                    Solution</a></h4>
                              <div class="tp-service-item__button-link">
                                 <a href="service.php">
                                    <span>
         ...
         <div class="container-fluid">
            <div class="row g-0 justify-content-center">
               <div class="col-xl-6">
                  <div class="tp-case-title-box mb-60 text-center wow tpfadeUp" data-wow-duration=".7s"
                     data-wow-delay=".5s">
                     <h3 class="tp-section-subtitle">Our Portfolio</h3>
                     <h3 class="tp-section-title-sm">Look at our Recent <br> Creativity</h3>
                  </div>
               </div>
            </div>
            ...
            <div class="row wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
               <div class="case-button mt-30 text-center">
                  <a class="tp-btn" href="https://api.whatsapp.com/send?phone=918866682459&text=Hey%20FM%2C%20I%20wan%20see%20your%20portfolio...%F0%9F%91%80">More Creativity</a>
               </div>
            </div>
         </div>
      </div>
                  ...
                  <div class="tp-testimonial-three text-center wow tpfadeUp" data-wow-duration=".7s"
                     ...
                     <div class="tp-testimonial-three__content">
                        ...
                        <div class="tp-testimonial-three__content-text">
                           <p>I have my important project going on with this company and let me tell you that I am more than satisfied.</p>
                        </div>
                     </div>
                     <div class="tp-testimonial-three__user">
                        ...
                        <div class="tp-testimonial-three__user-content">
                           <h4 class="user-title">Mr. Akash</h4>
                           <span>Founder of Class Times</span>
                        </div>
                     </div>
                  </div>
                  <div class="tp-testimonial-three text-center wow tpfadeUp" data-wow-duration=".7s"
                     ...
                     <div class="tp-testimonial-three__content">
                        ...
                        <div class="tp-testimonial-three__content-text">
                           <p>Website development team exceeded my expectations. Professional and efficient service!</p>
                        </div>
                     </div>
                     <div class="tp-testimonial-three__user">
                        <div class="tp-testimonial-three__user-img">
                        ...
                        <div class="tp-testimonial-three__user-content">
                           <h4 class="user-title">Pratyam Tech</h4>
                           <span>Disha Patil</span>
                        </div>
                     </div>
                  </div>
                  <div class="tp-testimonial-three text-center wow tpfadeUp" data-wow-duration=".7s"
                     ...
                     <div class="tp-testimonial-three__content">
                        ...
                        <div class="tp-testimonial-three__content-text">
                           <p>Services from Firms Marketing are reliable and secure. Our website has experienced zero downtime.</p>
                        </div>
                     </div>
                     <div class="tp-testimonial-three__user">
                        <div class="tp-testimonial-three__user-img">
                        ...
                        <div class="tp-testimonial-three__user-content">
                           <h4 class="user-title">Mr. Subash</h4>
                           <span>Founder of Mithradh</span>
                        </div>
                     </div>
                  </div>
                  <div class="tp-testimonial-three text-center wow tpfadeUp" data-wow-duration=".7s"
                     ...
                     <div class="tp-testimonial-three__content">
                        ...
                        <div class="tp-testimonial-three__content-text">
                           <p>Very knowledgeable about the services they provide. Would recommend it to anyone!</p>
                        </div>
                     </div>
                     <div class="tp-testimonial-three__user">
                        <div class="tp-testimonial-three__user-img">
                        ...
                        <div class="tp-testimonial-three__user-content">
                           <h4 class="user-title">Dr. Ronak</h4>
                           <span>Founder of Identzz</span>
                        </div>
                     </div>
                  </div>
                  <div class="tp-testimonial-three text-center wow tpfadeUp" data-wow-duration=".7s"
                     ...
                     <div class="tp-testimonial-three__content">
                        ...
                        <div class="tp-testimonial-three__content-text">
                           <p>The team members are also very supportive and professional with their response.</p>
                        </div>
                     </div>
                     <div class="tp-testimonial-three__user">
                        <div class="tp-testimonial-three__user-img">
                        ...
                        <div class="tp-testimonial-three__user-content">
                           <h4 class="user-title">Mr. Kp</h4>
                           <span>Founder of KP Insulation</span>
                        </div>
                     </div>
                  </div>
                  <div class="tp-testimonial-three text-center wow tpfadeUp" data-wow-duration=".7s"
                     ...
                     <div class="tp-testimonial-three__user">
                        ...
                        <div class="tp-testimonial-three__user-content">
                           <h4 class="user-title">Mr. Nirmal</h4>
                           <span>Founder of Stak Enterprise</span>
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <!-- contact & JS here -->
   <?php
      require 'files_contact.php';
      require 'files_social.php';
      require 'files_js_files.php';
      ?>
